...
class LogNewRequestListener implements ShouldQueue
{
    ...
    public function handle(NewRequestEvent $event)
    {
        try {
            ...
            if (isset($event->requestData['passport_token_id'])) {
                $requestLog->passport_token_id = $event->requestData['passport_token_id'];
            }
            ...
            if (isset($event->requestData['status_code'])) {
                $requestLog->status_code = $event->requestData['status_code'];
            }
